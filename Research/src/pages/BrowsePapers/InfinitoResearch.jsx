...
<div className="w-full lg:w-auto pt-10 lg:pt-32 px-0">
  ...
  {/* ✅ Desktop Indicators — placed directly below images */}
...
<div className="w-full lg:w-[28.125rem] lg:h-[28.25rem] bg-white text-black shadow-xl mt-6 lg:mt-0 lg:ml-20 py-6 px-5 sm:px-8 lg:py-12 lg:px-10 z-50">
  ...
  <button className="border-2 h-[2.625rem] w-[9.375rem] text-[#202020] border-[#202020] text-[0.75rem] font-semibold hover:bg-black hover:text-white transition">
    VIEW PAPER ›
  </button>
</div>

{/* ✅ Mobile Indicators (only shown on small screens) */}
