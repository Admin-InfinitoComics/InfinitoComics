...
//                 enhance user experience (see Cookie Policy for details).
//               </li>
//             </ul>
//           </Section>
...
//           <Section title="Parental Consent & Child Data Protection" icon="🛡️">
//             <p>
//               In accordance with Indian law, users below the age of 18 are
//               considered minors. As such, access to certain features or services
//               requires verified parental or guardian consent. We offer tools
//               that allow parents to:
//             </p>
//             <section>
//               <ul className="list-disc pl-5 text-gray-700">
...
//                 <li>
//                   Request correction or deletion of their child’s personal
//                   data.
//                 </li>
//               </ul>
//             </section>
//             <p>We take all necessary steps to protect children's data, including applying high standards of
// encryption and avoiding any form of unnecessary or invasive data collection.
// </p>
//           </Section>

//           <Section title="Data Sharing & Disclosure" icon="🔗">
//             <p>
//               We do not sell personal information. Data is shared only with
//               verified parental consent (for minors), trusted service providers
//               under confidentiality, legal requirements, or business transfers,
//               always with strong security.
//             </p>
//           </Section>

//           <Section title="Cookies & Tracking Technologies" icon="🍪">
//             <p>
//               Cookies are used to maintain sessions, customize navigation,
//               prevent inappropriate content, and collect anonymous statistics.
//               Users can accept/decline cookies, with minimal, non-invasive
//               cookies for children.
//             </p>
//           </Section>

//           <Section title="Data Storage, Retention & Security" icon="💾">
//             <p>
//               Data is stored on secure servers in India or approved locations.
//               Measures include SSL encryption, firewalls, role-based access, and
//               audits. Data is retained only as long as necessary; inactive child
//               accounts may be deleted.
//             </p>
//           </Section>

//           <Section title="User Rights" icon="📜">
//             <ul className="list-disc pl-5 text-gray-700">
//               <li>Access your data.</li>
//               <li>Correct inaccuracies.</li>
//               <li>Withdraw consent.</li>
//               <li>Request deletion.</li>
//               <li>Be informed of breaches.</li>
//               <li>File grievances with the Data Protection Board.</li>
//             </ul>
//           </Section>

//           <Section title="Grievance Redressal" icon="📞">
//             <p>
//               We comply with IT and DPDP rules, appointing a Grievance Officer
//               to handle privacy concerns within 15 business days.
//             </p>
//           </Section>

//           <Section title="Updates to This Policy" icon="🔄">
//             <p>
//               This policy may change with updates posted on our website. Users
//               are encouraged to review it regularly.
//             </p>
//           </Section>

//           <Section title="Final Assurance" icon="🤝">
//             <p>
//               Infinito Comics is committed to creating a safe, respectful space,
//               handling your information with care and legal compliance.
//             </p>
//           </Section>
//         </div>
