...
const FilterSideBar = () => {
  return (
    <div className="w-[310px] p-4  sticky top-0 h-[712px] overflow-y-auto bg-white">
      <h2 className="text-lg font-semibold mb-4">Refine publications by</h2>

      <div className="mb-4">
        <label className="block text-sm font-medium mb-1">Select subject area</label>
      ...
      <div className="mb-4">
        <label className="block text-sm font-medium mb-1">Select secondary subject area</label>
        <select className="w-full border px-2 py-1 rounded">
      ...
      <div className="mb-4">
        <h3 className="font-medium mb-1">Publication type</h3>
