...
const ExclusiveContent = () => {
  ...
  return loading? <ExclusiveContentShimmer/>: (
    ...
    <div className="flex flex-col w-full min-h-[500px] gap-5 px-4 md:px-8 lg:px-0">
      ...
      {/* Content section: image on left, text and buttons on right (stacked on small screens) */}
      <div className="flex flex-col lg:flex-row justify-around w-full min-h-[450px]">
        ...
        {/* Right section: text, store buttons and QR code */}
        <div className="w-full lg:w-[45%] px-4 sm:px-8 lg:px-0">
          <div className="flex flex-col items-center lg:items-start justify-start lg:w-[50%] gap-6 my-8 lg:my-40">
            ...
            {/* Store buttons and QR code section */}
            <div className="flex flex-col sm:flex-row gap-5 items-center">
              ...
              <div className="flex flex-row sm:flex-col items-center gap-4">
                ...
                {/* App Store button */}
                <button className="w-40 inline-flex items-center rounded-full border border-black bg-white px-4 py-2 hover:bg-gray-100 transition">
                  <svg
                  ...
                  <span className="ml-3 flex flex-col items-start leading-tight text-left">
                    <span className="text-[10px] sm:text-[11px] text-black">Download on </span>
                    <span className="text-xs sm:text-sm font-medium text-black">App Store</span>
                  </span>
                </button>
                ...
                <button className="w-40 inline-flex items-center rounded-full border border-black bg-white px-4 py-2 hover:bg-gray-100 transition">
                  ...
                  <span className="ml-3 flex flex-col items-start leading-tight text-left">
                    <span className="text-[10px] sm:text-[11px] text-black">GET IT ON</span>
                    <span className="text-xs sm:text-sm font-medium text-black">Google Play</span>
                  </span>
                </button>
              </div>

              {/* QR Code section with small caption */}
